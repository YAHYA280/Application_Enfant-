...
export const Modules = [
  {
    id: "1",
    name: "Français",
    image: images.français,
    category: "Langues",
    categoryId: "1",
    numberOfLessonsCompleted: 10,
    totalNumberOfLessons: 20,
    description: "Améliorez vos compétences en langue française.",
    estimatedTime: "15h",
  ...
  },
  {
    ...
    category: "Sciences",
    categoryId: "2",
    numberOfLessonsCompleted: 15,
    totalNumberOfLessons: 30,
    description: "Révisez les concepts fondamentaux des mathématiques.",
    estimatedTime: "20h",
    progressPercentage: 50,
    exercises: [
      {
  ...
  },
  {
    id: "3",
    name: "Physique",
    image: images.physique,
    category: "Sciences",
    categoryId: "2",
    numberOfLessonsCompleted: 8,
    totalNumberOfLessons: 25,
    description: "Explorez les principes de la physique moderne.",
    estimatedTime: "18h",
  ...
  },
  {
    id: "4",
    name: "Histoire",
    image: images.histoire,
    category: "Sciences Humaines",
    categoryId: "3",
    numberOfLessonsCompleted: 12,
    totalNumberOfLessons: 18,
    description: "Découvrez les événements historiques marquants.",
    estimatedTime: "12h",
  ...
  },
  {
    id: "5",
    name: "Géographie",
    image: images.geographie,
    category: "Sciences Humaines",
    categoryId: "3",
    numberOfLessonsCompleted: 9,
    totalNumberOfLessons: 15,
    description: "Étudiez les continents, climats et territoires.",
    estimatedTime: "10h",
  ...
  },
  {
    ...
    categoryId: "4",
    numberOfLessonsCompleted: 20,
    totalNumberOfLessons: 25,
    description: "Apprenez les bases de la programmation et des algorithmes.",
    estimatedTime: "25h",
  ...
  },
  {
    id: "7",
    name: "Anglais",
    image: images.anglais,
    category: "Langues",
    categoryId: "1",
    numberOfLessonsCompleted: 25,
    totalNumberOfLessons: 30,
    description: "Développez votre maîtrise de l'anglais.",
    estimatedTime: "20h",
    ...
    exercises: [
      ...
      },
      {
        id: "a2",
        num: "2",
        title: "Vocabulaire et expressions",
        duration: "30 mins",
        isCompleted: false,
      },
      {
  ...
  },
  {
    ...
    category: "Sciences",
    categoryId: "2",
    numberOfLessonsCompleted: 7,
    totalNumberOfLessons: 22,
    description: "Analysez les réactions chimiques et les éléments.",
    estimatedTime: "16h",
  ...
  },
  {
    ...
    category: "Sciences Humaines",
    categoryId: "3",
    numberOfLessonsCompleted: 18,
    totalNumberOfLessons: 25,
    description: "Comprenez les principes fondamentaux de l'économie.",
    estimatedTime: "14h",
...
export interface Question {
  ...
  type:
    ...
    | "speaking";
  text: string;
  correctAnswer?: string | boolean; // For multipleChoice, trueOrFalse, fillInBlank
  options?: { id: string; text: string }[]; // For multipleChoice
  expectedKeywords?: string[]; // For shortAnswer
  guidanceText?: string; // For speaking questions
}

export interface ModuleSubject {
  [moduleId: string]: Question[];
}

export interface ModuleQuestions {
  [subjectCode: string]: ModuleSubject;
}
    ...
    f1: [
      {
        id: "f1q1",
        type: "multipleChoice",
        text: "Quel est l'article défini pour 'livre' ?",
        options: [
          { id: "a", text: "la" },
          { id: "b", text: "le" },
          { id: "c", text: "l'" },
      ...
      },
      {
        id: "f1q2",
        type: "trueOrFalse",
        text: "Le nom 'livre' est masculin.",
        correctAnswer: true,
      },
    ],
    f2: [
      {
        id: "f2q1",
        type: "fillInBlank",
        text: "Conjuguez le verbe 'être' à la première personne du singulier du présent : Je _____.",
        correctAnswer: "suis",
      },
      {
        id: "f2q2",
        type: "shortAnswer",
        text: "Expliquez la différence entre les verbes du premier et du deuxième groupe.",
        expectedKeywords: ["terminaison", "er", "ir"],
      },
    ],
  },
    ...
    m1: [
      {
        id: "m1q1",
        type: "multipleChoice",
        text: "Que représente x dans l'équation x + 5 = 10 ?",
        options: [
          { id: "a", text: "3" },
          { id: "b", text: "5" },
          { id: "c", text: "7" },
    ...
    m2: [
      {
        id: "m2q1",
        type: "fillInBlank",
        text: "Un triangle avec des angles de 90, 45 et 45 degrés est appelé _____.",
        correctAnswer: "triangle rectangle",
      },
      {
        id: "m2q2",
        type: "shortAnswer",
        text: "Décrivez comment calculer l'aire d'un triangle.",
        expectedKeywords: ["base", "hauteur", "diviser par deux"],
      },
    ],
  },
  ...
  Physique: {
    p1: [
      ...
      },
      {
        id: "p1q2",
        type: "trueOrFalse",
        text: "La vitesse est un vecteur.",
        correctAnswer: true,
      },
    ],
    p2: [
      {
        id: "p2q1",
        type: "fillInBlank",
        text: "L'unité de charge électrique est le _____.",
        correctAnswer: "Coulomb",
      },
      {
        id: "p2q2",
        type: "speaking",
        text: "Expliquez le principe de l'électromagnétisme.",
        guidanceText:
          "Parlez des interactions entre champs électriques et magnétiques.",
      },
    ],
  },
    ...
    h1: [
      {
        id: "h1q1",
        type: "multipleChoice",
        text: "Qui a construit les pyramides d'Égypte ?",
        options: [
          { id: "a", text: "Les Romains" },
          { id: "b", text: "Les Grecs" },
          { id: "c", text: "Les Égyptiens" },
          { id: "d", text: "Les Perses" },
        ],
        correctAnswer: "c",
      },
      {
        id: "h1q2",
        type: "trueOrFalse",
        text: "L'Égypte antique a duré plus de 3000 ans.",
        correctAnswer: true,
      },
    ],
    h2: [
      {
        id: "h2q1",
        type: "shortAnswer",
        text: "Décrivez le système féodal au Moyen Âge.",
        expectedKeywords: ["seigneurs", "paysans", "hiérarchie", "terres"],
      },
      {
        id: "h2q2",
        type: "fillInBlank",
        text: "La Guerre de Cent Ans a opposé la _____ et l'_____.",
        correctAnswer: "France, Angleterre",
      },
    ],
  },
};
