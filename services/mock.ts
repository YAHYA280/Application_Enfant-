...
export const mockChallenges: Challenge[] = [
  {
    ...
    nombreTentatives: 5,
    accessible: true,
    messageFailed: "👏 Félicitations ! Tu as brillamment relevé ce challenge ! 🎉 Ton travail acharné et ta persévérance ont payé. Continue sur cette lancée, chaque succès te rapproche encore plus de tes objectifs. 🚀🔥",
    messageReuse: "Ne te décourage pas ! 💪 Chaque échec est une leçon qui te rapproche de la réussite. Ce challenge n’était qu’une étape, pas une fin en soi. Analyse, apprends et reviens encore plus fort. Tu as tout ce qu’il faut pour y arriver ! 🚀🔥",
  ...
  },
  {
    ...
    difficulte: DifficulteChallenge.MOYEN,
    description: "Enrichissez votre vocabulaire et améliorez votre compréhension",
...
export const mockExercices: Exercice[] = [
  ...
  
  {
    ...
    chrono: 45,
    contenu: "Conjuguez le verbe 'être' à la première personne du singulier du présent : Je _____.",
  ...
  },
  {
    ...
    chrono: 45,
    contenu: "Conjuguez le verbe 'avoir' à la deuxième personne du pluriel du présent : Vous _____.",
    typeExercice: TypeExercice.QUESTION_OUVERTES,
    choix: [],
  ...
  },
  {
    ...
    chrono: 45,
    contenu: "Conjuguez le verbe 'aller' à la troisième personne du pluriel du présent : Ils _____.",
    typeExercice: TypeExercice.QUESTION_OUVERTES,
    choix: [],
  ...
  },
  {
    ...
    chrono: 60,
    contenu: "Lisez le texte suivant et répondez à la question : 'Le soleil se couchait à l'horizon, teintant le ciel de nuances de rose et d'orange. Marie contemplait ce spectacle depuis son balcon.' À quel moment de la journée se passe cette scène ?",
    typeExercice: TypeExercice.QCM,
